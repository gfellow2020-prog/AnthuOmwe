...
<style>
    ...
    .btn-primary  { display:inline-flex;align-items:center;gap:6px;padding:8px 18px;font-size:13px;font-weight:600;
                    background:#2563eb;color:#fff;border-radius:8px;border:none;cursor:pointer; }
    .btn-primary:hover  { background:#1d4ed8; }
    .btn-success  { display:inline-flex;align-items:center;gap:6px;padding:8px 18px;font-size:13px;font-weight:600;
                    background:#16a34a;color:#fff;border-radius:8px;border:none;cursor:pointer; }
...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Lab Queue</h1>
        <p class="text-sm text-gray-500 mt-0.5">Sample collection &amp; result recording</p>
    </div>
...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-green-200">
        ...
        <div class="divide-y divide-gray-100">
            ...
            <div class="flex items-center justify-between px-6 py-4 hover:bg-gray-50 transition">
                ...
                <a href="{{ route('lab.show', $enc) }}" class="btn-success text-xs px-3 py-1.5">Record Results</a>
            </div>
            @endforeach
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
            ...
            <h2 class="text-base font-semibold text-gray-900 dark:text-white">Waiting for Lab</h2>
