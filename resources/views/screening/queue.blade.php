...
<span class="text-neutral-700 dark:text-neutral-200 font-medium">Screening Queue</span>
@endsection
                ...
                <div class="flex items-center justify-between px-6 py-4 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-neutral-700 dark:text-neutral-400 font-medium mt-0.5">⚠ Allergies noted</p>
                            @endif
                        </div>
                    </div>
            ...
            <div class="divide-y divide-neutral-200 dark:divide-neutral-700">
                ...
                <div class="flex items-center justify-between px-6 py-4 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span class="badge badge-{{ $enc->priority_level }}">{{ ucfirst($enc->priority_level) }}</span>
                        @endif
                        <a href="{{ route('screening.show', $enc) }}" class="btn-primary text-xs px-3 py-1.5">
                            Continue Assessment
                        </a>
                    </div>
                </div>
