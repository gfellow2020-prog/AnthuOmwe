...
<body class="min-h-screen bg-slate-100 dark:bg-gray-950 text-gray-800 dark:text-gray-100 antialiased">

    <div class="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.10),_transparent_45%)] dark:bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.14),_transparent_45%)]">
        <header class="sticky top-0 z-40 border-b border-white/70 dark:border-gray-800 bg-white/85 dark:bg-gray-900/85 backdrop-blur">
            <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
                    ...
                    <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                        ...
                        <div x-show="open" x-transition
                            ...
                            <a href="{{ route('triage.queue') }}"
                               class="flex items-center gap-2.5 px-3 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition">
                ...
                <div class="flex items-center gap-1 shrink-0">
                    ...
                    <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                        <button @click="open = !open"
                                class="w-9 h-9 rounded-full bg-blue-600 flex items-center justify-center text-white text-xs font-bold hover:bg-blue-700 transition ml-1">
                        ...
                        <div x-show="open" x-transition
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit"
                                        class="w-full flex items-center gap-2 px-3 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
